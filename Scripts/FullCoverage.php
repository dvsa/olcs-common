...
$testDirectories = ['common' => realpath(__DIR__ . '/../test'), 'backend' => realpath(__DIR__ . '/../../olcs-backend/test'), 'internal' => realpath(__DIR__ . '/../../olcs-internal/test'), 'selfserve' => realpath(__DIR__ . '/../../olcs-selfserve/test')];
