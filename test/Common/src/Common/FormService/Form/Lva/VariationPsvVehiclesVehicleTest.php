...
/**
 * Variation Psv Vehicles Vehicle Test
 *
...
use Common\FormService\Form\Lva\VariationPsvVehiclesVehicle;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class VariationPsvVehiclesVehicleTest extends MockeryTestCase
{
    protected $sut;
    ...
    public function setUp()
    {
        ...
        $this->sut = new VariationPsvVehiclesVehicle();
