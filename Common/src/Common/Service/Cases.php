...
class Cases
{
    const CASE_CATEGORY_NR = 'case_cat_compl_erru_msi';
    const NR_CATEGORY_DEFAULT = 'erru_case_t_msirnys'; //MSI with no response sent
    const NR_DEFAULT_INFRINGEMENT_CATEGORY = 'MSI'; //currently the only one we have
