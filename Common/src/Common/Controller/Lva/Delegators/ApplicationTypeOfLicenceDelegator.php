...
/**
 * Application Type Of Licence Delegator
 *
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class ApplicationTypeOfLicenceDelegator implements DelegatorFactoryInterface
{
    ...
    public function createDelegatorWithName(ServiceLocatorInterface $serviceLocator, $name, $requestedName, $callback)
    {
        ...
        $adapter = $serviceLocator->getServiceLocator()->get('ApplicationTypeOfLicenceAdapter');
