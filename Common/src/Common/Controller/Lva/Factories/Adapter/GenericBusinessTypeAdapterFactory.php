...
class GenericBusinessTypeAdapterFactory implements FactoryInterface
{
     ...
     */
    public function createService(ServiceLocatorInterface $serviceLocator): GenericBusinessTypeAdapter
    {
        $container = method_exists($serviceLocator, 'getServiceLocator') ? $serviceLocator->getServiceLocator() : $serviceLocator;

        return $this->__invoke($container, GenericBusinessTypeAdapter::class);
    }
