...
use Common\FormService\Form\Lva\VehiclesDeclarationsSmall;
use Common\FormService\Form\Lva\VehiclesDeclarationsLarge;
use Common\FormService\Form\Lva\VehiclesDeclarationsBoth;
...
class FormServiceAbstractFactory implements AbstractFactoryInterface
{
    public const FORM_SERVICE_CLASS_ALIASES = [
        ...
        'lva-variation-vehicles_declarations_size' => VehiclesDeclarationsSize::class,
        'lva-application-vehicles_declarations_size' => VehiclesDeclarationsSize::class,
        'lva-variation-vehicles_declarations_large' => VehiclesDeclarationsLarge::class,
        'lva-application-vehicles_declarations_large' => VehiclesDeclarationsLarge::class,
        'lva-variation-vehicles_declarations_both' => VehiclesDeclarationsBoth::class,
        'lva-application-vehicles_declarations_both' => VehiclesDeclarationsBoth::class,
        'lva-variation-vehicles_declarations_small' => VehiclesDeclarationsSmall::class,
        'lva-application-vehicles_declarations_small' => VehiclesDeclarationsSmall::class,
