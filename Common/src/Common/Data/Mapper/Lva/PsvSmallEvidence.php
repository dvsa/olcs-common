 ...
 */
class PsvSmallEvidence implements MapperInterface
{
    public static function mapFromResult(array $data): array
    {
        ...
        switch (true) {
            case $data['smallVehicleEvidenceUploaded'] === RefData::AD_UPLOAD_NOW:
                $uploadNow = RefData::AD_UPLOAD_NOW;
                break;
            case $data['smallVehicleEvidenceUploaded'] === RefData::AD_UPLOAD_LATER:
