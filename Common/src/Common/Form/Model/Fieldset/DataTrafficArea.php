...
class DataTrafficArea
{
     ...
     * @Form\Options({
     *     "label":
     * "application_operating-centres_authorisation.dataTrafficArea.label.new",
     *     "value_options": {
     *
     *     },
     ...
     * @Form\Attributes({
     *     "value":
     * "application_operating-centres_authorisation.dataTrafficArea.label.exists"
     * })
