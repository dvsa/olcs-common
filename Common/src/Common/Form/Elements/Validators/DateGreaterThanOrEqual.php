 ...
 */
class DateGreaterThanOrEqual extends AbstractValidator
{
    /**
     * Error codes
     * @const string
     */
    const NOT_GREATER_THAN_OR_EQUAL =
    ...
    protected $messageTemplates = array(
        self::NOT_GREATER_THAN_OR_EQUAL => "This is before a corresponding
        date, it must be the same date or after",
    ...
    public function isValid($value, array $context = null)
    {
        ...
        if (!($thisValue >= $compareValue)) {
            $this->error(self::NOT_GREATER_THAN_OR_EQUAL);
            return false;
        }
