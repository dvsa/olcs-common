 ...
 * @author Jessica Rowbottom <jess.rowbottom@valtech.co.uk>
 */
class VehicleUndertakingsNoLimousineConfirmation extends SingleCheckbox implements InputProviderInterface
{
    ...
    {
        return array(
            new VehicleUndertakingsNoLimousineConfirmationValidator()
        );
    }
