...
//die();
    ...
    protected function hasChangedTradingNames($orgId, $tradingNames, $licenceId)
    {
        return $this->getServiceLocator()->get('Entity\Organisation')->hasChangedTradingNames($orgId, $tradingNames, $licenceId);
    }
}
