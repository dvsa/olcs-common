...
$ni = array_merge(
    ...
    [
        ...
        'delete.final-tm.confirmation.text' => 'You are removing your last Transport Manager. If you haven\'t yet made an application to appoint a replacement, you must contact us on {{OPERATOR_LICENSING_PHONE}} or at <a href="mailto:{{OPERATOR_LICENSING_EMAIL_NI}}">{{OPERATOR_LICENSING_EMAIL_NI}}</a>',
    ]
);
