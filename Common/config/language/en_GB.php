...
return [
    ...
    'ERR_OC_T_3' => 'You can\'t have more trailers than the total accross your operating centres',
    ...
    'ERR_OC_V_3' => 'You can\'t have more vehicles than the total accross your operating centres',
    ...
    'application.payment-submission.amount.value' => '<div>Total fee(s) <h2>£%s</h2></div>',
    ...
    'manage-users.field.permission.admin.label' => '<strong>Administrator</strong><br />Has access to all licences and can manage users',
    'manage-users.field.permission.label' => 'Permission',
    'manage-users.field.permission.tm.label' => '<strong>Transport manager</strong><br />Can only access their own information',
    'manage-users.field.permission.user.label' => '<strong>Standard</strong><br />Has access to all licences',
    ...
    'submit-pay.button' => 'Submit and pay',
