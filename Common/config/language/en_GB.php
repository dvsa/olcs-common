...
return [
    ...
    'permits.application.overwiew.no-permits' => 'If you wish to transport goods internationally, you can apply for a new permit to do so.',
    ...
    'permits.page.euro6.emissions.info' => 'If you intend to transport goods internationally across the EU and EEA, the vehicle(s) you intend to use must meet and comply to all Euro 6 emission standards.',
    ...
    'permits.page.fee.title' => 'Fees for ECMT permit ',
    ...
    'permits.page.fee.permit.validity' => 'Permit validity',
    'permits.page.fee.number.permits' => 'Number of permits required',
    'permits.page.fee.permit.fee.single' => 'Application fee per permit',
    'permits.page.fee.permit.fee.total' => 'Total application fee to be paid (non-refundable)',
    ...
    'error.messages.permits.required.too-large' => 'ou must enter a number equal to or less than your total vehicle authority. You must correct it.',
