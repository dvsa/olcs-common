...
return [
 ...
 to all known addresses? <br/> If yes, this will be automatically issued tomorrow.',
    ...
    'permits.page.fee.message' => 'If your permit application is successful, you will have to pay an additional <a href="{{ECMT_FEES_FOR_PERMITS_GUIDANCE_LINK}}" target="_blank">issuing fee per permit<span class="govuk-visually-hidden">(link opens in a new window)</span></a> required.',
    ...
    'permits.page.irhp-fee.message' => 'If your permit application is successful, you will have to pay an additional <a href="{{ECMT_PERMITS_FURTHER_GUIDANCE_LINK}}#fees" target="_blank">issuing fee per permit<span class="govuk-visually-hidden">(link opens in a new window)</span></a> required.',
