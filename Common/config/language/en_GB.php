...
return [
 ...
 to all known addresses? <br/> If yes, this will be automatically issued tomorrow.',
    ...
    'permits.page.restricted-countries.guidance.euro5' => 'These ECMT permits cannot be used to transport goods to, through or from Austria, Greece, Hungary, Italy or Russia.',
    ...
    'permits.form.euro6.label' => 'I confirm that my ECMT permits will only be used by vehicles that are environmentally compliant with Euro 6 emissions standards.',
    'permits.form.restricted.countries.euro5.label' => 'I confirm that I will not transport goods to, through and from Austria, Greece, Hungary, Italy or Russia using this ECMT permit.',
    ...
    'error.messages.restricted.countries.euro5' => 'Tick to confirm you\'ll not use these permits to transport goods to or through Austria, Greece, Hungary, Italy or Russia',
    ...
    'qanda.ecmt-short-term.permit-usage.additional-guidance' => '<p>Short-term ECMT permits are only required when transiting through EU or EEA countries to non-EU/EEA countries, including Switzerland, or if your journey includes more than two onward legs (cross-trade) to other EU/EEA countries.</p><p>You must fill in the permit logbook with full details of the entire journey.</p><p>Confirm how you will be using short term permits:</p>',
