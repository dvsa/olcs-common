...
return [
    ...
    'internal-delete.final-tm.confirmation.text' => 'You are about to remove the last transport manager for this licence. Do you want to send a letter about this to the operator to all known addresses?',
    'internal-delete.final-tm.confirmation-info.text' => 'If yes, this will be automatically issued tomorrow.',
