...
return [
    ...
    'ebsr-upload-subtitle' => 'You can apply to register, change or cancel bus services online through the electronic bus service registration (EBSR) service.',
    'ebsr-upload-title' => 'Register, change or cancel bus services',
    'ebsr-upload-before' => 'Before you upload',
    'ebsr-support' => 'If you haven\'t done this before you\'ll need to email <a href="mailto:{{EBSR_SUPPORT_EMAIL}}">{{EBSR_SUPPORT_EMAIL}}</a> or call {{EBSR_SUPPORT_NUMBER}}.',
    'ebsr-paper' => 'You can also register, change or cancel bus services using the <a href="{{EBSR_PAPER_FORMS_LINK}}">paper forms</a>.',
