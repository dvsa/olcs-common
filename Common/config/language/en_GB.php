...
return [
 ...
 to all known addresses? <br/> If yes, this will be automatically issued tomorrow.',
    ...
    'qanda.ecmt.number-of-permits.question' => 'How many permits do you require for this licence?',
    'qanda.ecmt.number-of-permits.question-summary' => 'Number of permits',
    'qanda.ecmt.number-of-permits.additional-guidance' => '<p class="govuk-body">There is a %s non-refundable application fee per permit required.</p><p class="govuk-body">If successful, you\'ll pay an additional %s issuing fee per permit granted.</p>',
    'qanda.ecmt.number-of-permits.inset' => '<p>You must <strong>choose between Euro 5 and Euro 6</strong>. You cannot apply for both emissions standards during the same application period.</p><p>There is a very limited number of permits for use with Euro 5 vehicles.</p>',
    'qanda.ecmt.number-of-permits.annotation.line-1' => 'Number of permits',
    'qanda.ecmt.number-of-permits.annotation.line-2' => '%s is the maximum number you can apply for.',
    ...
    'qanda.ecmt.number-of-permits.label.euro5' => 'Permits for Euro 5 minimum emission standard',
    'qanda.ecmt.number-of-permits.label.euro6' => 'Permits for Euro 6 minimum emission standard',
    'qanda.ecmt.number-of-permits.error.category-max-exceeded' => 'There are only %s permits available for the selected emissions standard',
    'qanda.ecmt.number-of-permits.error.authorisation-max-exceeded' => 'You have exceeded the maximum you can apply for',
    'qanda.ecmt.number-of-permits.error.category-not-whole-number' => 'You must enter a valid whole number',
