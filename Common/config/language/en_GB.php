...
return [
 ...
 to all known addresses? <br/> If yes, this will be automatically issued tomorrow.',
    ...
    'licence.surrender.current_discs.content' => '<p>Our records show that you have %s current vehicle discs.</p><p>Please provide details of what you are going to do with all of the current discs associated to this licence.</p>',
