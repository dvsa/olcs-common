...
return [
    ...
    'ERR_IRHP_BIL_CAB_ONLY_STOCK_WITHOUT_CAB_RANGE' => 'You cannot open a window for this stock as there are no cabotage permit stock ranges and the application path requires at least one',
    'ERR_IRHP_BIL_CAB_ONLY_STOCK_WITHOUT_CAB_RANGE_WITH_STD_RANGE' => 'You cannot open a window for this stock as there are no cabotage permit stock ranges and the application path requires at least one, and there are standard permit stock ranges and the application path does not allow this',
    'ERR_IRHP_BIL_CAB_ONLY_STOCK_WITH_STD_RANGE' => 'You cannot open a window for this stock as it contains standard permit stock ranges and the application path does not allow this',
    'ERR_IRHP_BIL_STD_ONLY_STOCK_WITHOUT_STD_RANGE' => 'You cannot open a window for this stock as there are no standard permit stock ranges and the application path requires at least one',
    'ERR_IRHP_BIL_STD_ONLY_STOCK_WITHOUT_STD_RANGE_WITH_CAB_RANGE' => 'You cannot open a window for this stock as there are no standard permit stock ranges and the application path requires at least one, and there are cabotage permit stock ranges and the application path does not allow this',
    'ERR_IRHP_BIL_STD_ONLY_STOCK_WITH_CAB_RANGE' => 'You cannot open a window for this stock as there are cabotage permit stock ranges and the application path does not allow this',
    'ERR_IRHP_BIL_STD_AND_CAB_STOCK_WITHOUT_STD_RANGE' => 'You cannot open a window for this stock as there are no standard permit stock ranges and the application path requires at least one',
    'ERR_IRHP_BIL_STD_AND_CAB_STOCK_WITHOUT_STD_RANGE_WITHOUT_CAB_RANGE' => 'You cannot open a window for this stock as there are no standard or cabotage permit stock ranges and the application path requires at least one of each',
    'ERR_IRHP_BIL_STD_AND_CAB_STOCK_WITH_CAB_RANGE' => 'You cannot open a window for this stock as there are no cabotage permit stock ranges and the application path requires at least one',
    ...
    'application_community_licence_total_community_licences' => 'Active licences',
    'application_community_licence_total_community_licences.psv' => 'Active PSV certified copies',
    ...
    'application_operating-centres_authorisation.data.totCommunityLicences' => 'UK licences for the Community',
    'application_operating-centres_authorisation.data.totCommunityLicences.psv' => 'PSV certified copies',
    'application_operating-centres_authorisation.data.totCommunityLicences-external-app' => 'How many UK licence for the Community documents do you require for travelling to Europe?',
    'application_operating-centres_authorisation.data.totCommunityLicences.psv-external-app' => 'How many PSV certified copy documents do you require for travelling to Europe?',
    ...
    'closed' => 'Closed',
    'community-licence-changes-contact-office' => 'If you wish to request additional UK licence for the Community documents, please contact the central licensing office',
    'community-licence-changes-contact-office.psv' => 'If you wish to request additional PSV certified copies, please contact the central licensing office',
    ...
    'dashboard-table-permit-application-reference' => 'Application reference',
    ...
    'dashboard.link' => 'Home',
    'dashboard.licences.title' => 'Licences',
    'dashboard.permits.title' => 'Permits',
    'dashboard.fees.title' => 'Fees',
    'dashboard.correspondence.title' => 'Documents',
    'dashboard.tm.title' => 'Home',
    'dashboard.permits.empty' => 'No ongoing applications, or issued permits or certificates.',
    'date-Day' => 'Day',
    'date-Hour' => 'Hour',
    'date-Minute' => 'Minute',
    'date-Month' => 'Month',
 ...
 to all known addresses? <br/> If yes, this will be automatically issued tomorrow.',
    ...
    'lva.section.title.community_licences' => 'UK licences for the Community',
    'lva.section.title.community_licences.psv' => 'PSV certified copies',
    ...
    'lva.section.title.upload-evidence.supporting-evidence' => 'Other documents',
    ...
    'manage-users.inset-text-message' => 'Every person using this service must have their own username and password. Remove users who no longer need access to this service.',
    'manage-users.warning-message' => 'Your licence could be at risk if you share your username and password.',
    ...
    'page.title.lva-application/business_details.index' => 'Business details',
    'page.title.lva-application/business_details/action.add' => 'Add subsidiary company',
    'page.title.lva-application/addresses.index' => 'Addresses',
    'page.title.lva-application/people.index' => 'Directors',
    'page.title.lva-application/people/action.add' => 'Add person',
    'page.title.lva-application/people/action.edit' => 'Edit person',
    'page.title.lva-application/operating_centres.index' => 'Operating centres and authorisation',
    'page.title.lva-application/operating_centres/action.add' => 'Add operating centre',
    'page.title.lva-application/safety.index' => 'Safety and compliance',
    'page.title.lva-application/financial_history.index' => 'Financial history',
    'page.title.lva-application/licence_history.index' => 'Licence history',
    'page.title.lva-application/convictions_penalties.index' => 'Convictions and Penalties',
    'page.title.lva-application/financial_evidence.index' => 'Financial evidence',
    'page.title.lva-application/transport_managers.index' => 'Transport Managers',
    'page.title.lva-application/transport_managers/action.add' => 'Add Transport Manager',
    'page.title.lva-application/transport_managers/action.addNewUser' => 'Add Transport Manager',
    'page.title.lva-application/transport_managers/action.addTm' => 'Transport Manager details',
    'page.title.lva-application/vehicles.index' => 'Vehicle details',
    'page.title.lva-application/vehicles/action.add' => 'Add vehicle',
    'page.title.lva-application/vehicles/action.edit' => 'Edit vehicle',
    'page.title.lva-application/safety/action.add' => 'Add safety inspector',
    'page.title.lva-application/safety/action.edit' => 'Edit safety inspector',
    'page.title.lva-application/undertakings.index' => 'Review and declarations',
    'page.title.lva-application/submission-summary.postSubmitSummary' => 'Application overview',
    'page.title.lva-variation/type_of_licence.index' => 'Type of licence',
    'page.title.lva-variation/business_type.index' => 'Business type',
    'page.title.lva-variation/business_details.index' => 'Business details',
    'page.title.lva-variation/business_details/action.add' => 'Add subsidiary company',
    'page.title.lva-variation/business_details/action.edit' => 'Edit subsidiary company',
    'page.title.lva-variation/addresses.index' => 'Addresses',
    'page.title.lva-variation/people.index' => 'Directors',
    'page.title.lva-variation/people/action.add' => 'Add person',
    'page.title.lva-variation/people/action.edit' => 'Edit person',
    'page.title.lva-variation/operating_centres.index' => 'Operating centres and authorisation',
    'page.title.lva-variation/operating_centres/action.add' => 'Add operating centre',
    'page.title.lva-variation/operating_centres/action.edit' => 'Edit operating centre',
    'page.title.lva-variation/financial_evidence.index' => 'Financial evidence',
    'page.title.lva-variation/vehicles.index' => 'Vehicle details',
    'page.title.lva-variation/vehicles/action.add' => 'Add vehicle',
    'page.title.lva-variation/vehicles/action.edit' => 'Edit vehicle',
    'page.title.lva-variation/safety.index' => 'Safety and compliance',
    'page.title.lva-variation/safety/action.add' => 'Add safety inspector',
    'page.title.lva-variation/safety/action.edit' => 'Edit safety inspector',
    'page.title.lva-variation/undertakings.index' => 'Review and declarations',
    'page.title.lva-variation/transport_managers.index' => 'Transport Managers',
    'page.title.lva-variation/pay-and-submit.payAndSubmit' => 'Pay fees',
    'page.title.licence/surrender/start/GET.index' => 'Apply to surrender your goods vehicle operator\'s licence',
    'page.title.licence/surrender/review-contact-details/GET.index' => 'Review your contact information',
    'page.title.licence/surrender/address-details.index' => 'Addresses',
    'page.title.licence/surrender/operator-licence/GET.index' => 'Where is your operator licence document?',
    'page.title.licence/surrender/review/GET.index' => 'Review your surrender information',
    'page.title.licence/surrender/operator-licence/review/GET.index' => 'Where is your operator licence document?',
    'page.title.licence/surrender/destroy/GET.index' => 'Now securely destroy your licence documentation',
    'page.title.licence/surrender/declaration/GET.index' => 'Declaration',
    'page.title.licence/surrender/declaration/POST.index' => 'What you need to do next',
    'page.title.cookies.generic' => 'Details about cookies',
    'page.title.cookies/settings.generic' => 'Cookies',
    'page.title.lva-application/transport_manager_details.details' => 'Transport Manager details',
    ...
    'page.title.bus-registration/details.details' => 'Bus registration details',
    'page.title.change-password.index' => 'Change your password',
    'page.title.lva-licence.index' => 'View and amend your licence',
    'page.title.lva-licence/type_of_licence.index' => 'Type of licence',
    'page.title.lva-licence/business_type.index' => 'Business type',
    'page.title.lva-licence/business_details.index' => 'Business details',
    'page.title.lva-licence/business_details/action.add' => 'Add subsidiary company',
    'page.title.lva-licence/business_details/action.edit' => 'Edit subsidiary company',
    'page.title.lva-licence/addresses.index' => 'Addresses',
    'page.title.lva-licence/people.index' => 'Directors',
    'page.title.lva-director_change/people.index' => 'Add a director',
    'page.title.lva-licence/people/action.edit' => 'Edit person',
    'page.title.lva-licence/operating_centres.index' => 'Operating centres and authorisation',
    'page.title.lva-licence/vehicles.index' => 'Vehicle details',
    'page.title.lva-licence/vehicles/action.add' => 'Add vehicle',
    'page.title.lva-licence/vehicles/action.edit' => 'Edit vehicle',
    'page.title.lva-licence/trailers.index' => 'Trailers',
    'page.title.lva-licence/trailers/action.add' => 'Add trailer',
    'page.title.lva-licence/trailers/action.edit' => 'Edit trailer',
    'page.title.lva-licence/safety.index' => 'Safety and compliance',
    'page.title.lva-licence/safety/action.add' => 'Add safety inspector',
    'page.title.lva-licence/safety/action.edit' => 'Edit safety inspector',
    'page.title.lva-licence/transport_managers.index' => 'Transport Managers',
    'page.title.lva-licence/discs.index' => 'Licence discs',
    'page.title.lva-licence/discs/action.add' => 'Request discs',
    'page.title.lva-licence/discs/action.index' => 'Licence discs',
    'page.title.lva-licence/taxi_phv.index' => 'Taxi and PHV',
    'page.title.lva-licence/taxi_phv/action.add' => 'Add Taxi/PHV',
    'page.title.lva-licence/taxi_phv/action.edit' => 'Edit Taxi/PHV',
    'page.title.lva-licence/conditions_undertakings.index' => 'Conditions and undertakings',
    ...
    'page.title.search-bus/browse/results.results' => 'Search results',
    ...
    'page.title.dashboard.index' => 'Licences',
    ...
    'page.title.fees/late.late-fee' => 'Pay fee',
    'page.title.fees/pay.pay-fees' => 'Pay fee',
    'page.title.fees/receipt.receipt' => 'Payment successful',
    ...
    'section.name.community_licences' => 'UK licences for the Community',
    'section.name.community_licences.psv' => 'PSV certified copies',
    ...
    'sidebar-guidance-on-permits' => 'Guidance on permits',
    ...
    'supply-supporting-evidence-text-hint' => 'Upload additional or outstanding documents to support your application.',
    ...
    'supply-supporting-evidence-warning' => "Make sure your files have short meaningful names for example 'advert_evidence' or 'BankStatement'.",
    'upload-evidence-button' => 'Add documents',
    'surname' => 'Surname',
    't-auth' => 'T-auth',
    ...
    'address_addressLine2' => 'Address line 2 (optional)',
    'address_addressLine3' => 'Address line 3 (optional)',
    'address_addressLine4' => 'Address line 4 (optional)',
    ...
    'permits.application.overview.start-your-application' => 'Start your application',
    'permits.application.overview.select-countries' => 'Select countries you need permits for',
    'permits.application.overview.answer-country-questions' => 'Answer questions for individual countries',
    'permits.application.overview.review-and-submit' => 'Review and submit',
    'permits.application.overview.edit-country-selection' => 'Edit country selection',
    'permits.application.overview.read-declaration' => 'Read declaration',
    'permits.application.overview.submit-and-pay' => 'Submit and pay',
    ...
    'permits.page.confirmation.irhp-submitted.what-happens-next' => 'Your valid permits will be grouped together under the same licence number that you applied with.<p>We will now post your paper permit and corresponding logbook within the next 3 working days.</p><p>In the meantime, check if you have the Certificate of Compliance and Certificate of Roadworthiness for each vehicle and trailer you intend to use.</p>',
    ...
    'permits.page.roadworthiness.guidance' => 'If your permit application is successful, you are required to have the appropriate <strong>Certificate of Compliance</strong> and <strong>Certificate of Roadworthiness</strong> for each vehicle and trailer you intend to use.<br/><br/>You must carry the certificates that match your vehicle and trailer, for the whole of your journey.<br/><br/>If you don\'t have it already, <a href="{{ECMT_RULES_FOR_USING_PERMITS_GUIDANCE_LINK}}" target="_blank">find out how to get the certificates (opens in new window)<span class="govuk-visually-hidden">(link opens in a new window)</span></a>.',
    'permits.form.roadworthiness.label' => 'I understand that I must obtain and carry the appropriate Certificate of Compliance and Certificate of Roadworthiness for each vehicle and trailer I intend to use with this permit.',
    ...
    'permits.page.number-of-trips.title' => 'How many international trips did you make in the last 12 months using this licence?',
    ...
    'permits.page.type.title' => 'Select a permit type or certificate to apply for',
    ...
    'permits.page.year.browser.title.one-year-available' => 'Validity period',
    'permits.page.year.question.one-year-available' => 'Validity period',
    'permits.page.year.hint.one-year-available' => 'Permits requested will be valid for %s.',
    ...
    'permits.page.select.stock.must.choose.morocco' => 'Select the Morocco permit you need',
    'permits.page.select.year.must.choose' => 'You must select one year to continue',
    'permits.page.international.journey.title' => 'In the last 12 months, what percentage of international trips did you make using this licence?',
    ...
    'permits.page.restricted-countries.title' => 'Will you be transporting goods to Austria, Greece, Hungary, Italy or Russia?',
    ...
    'permits.page.permits.required.title' => 'How many permits do you require for this licence?',
    ...
    'permits.page.declaration.bullet.list.title' => 'By continuing, you confirm that you',
    'permits.page.declaration.additional.warning' => 'It is an offence to make a false declaration to obtain a permit or certificate and you could be fined or prosecuted.',
    'permits.page.cancel.browser.title' => 'Cancel application',
    'permits.page.cancel.question' => 'Cancel application',
    'permits.page.cancel.bullet.list.title' => 'By cancelling you understand that',
    ...
    'permits.page.decline.browser.title' => 'Decline granted permits',
    'permits.page.decline.question' => 'Decline granted permits',
    'permits.page.decline.bullet.list.title' => 'By declining these permits, you agree that',
    'permits.page.fee.main' => 'Application fee for ECMT permit',
    'permits.page.fee.browser.title' => 'Permit fee',
    ...
    'permits.page.fee.per-permit' => '%s x %s (per permit) <a class="govuk-link govuk-!-display-block" href="%s" target="_blank">View Permits<span class="govuk-visually-hidden">(link opens in a new window)</span></a>',
    ...
    'permits.page.fee.permit.fee.amount-paid' => 'Amount paid',
    'permits.page.fee.permit.fee.amount-remaining' => 'Amount remaining',
    'permits.page.fee.permit.fee.already-paid' => 'Already paid',
    'permits.page.fee.permit.fee.to-be-paid' => 'To be paid',
    ...
    'permits.page.irhp-fee.message' => 'If your application is successful, you will have to pay an additional issuing fee for each permit granted.',
    'permits.page.irhp-fee.message.total-already-paid' => 'You have already paid the total fee for these permits.',
    ...
    'bilateral.permit.category.hint.standard-multiple-15.2020' => 'Allows 15 return journeys within a calendar year.',
    'bilateral.permit.category.label.standard-multiple-15.2021' => 'Standard multiple journey permit for 2021',
    'bilateral.permit.category.hint.standard-multiple-15.2021' => 'Allows 15 return journeys within a calendar year.',
    'bilateral.permit.category.label.standard-multiple-15.2022' => 'Standard multiple journey permit for 2022',
    'bilateral.permit.category.hint.standard-multiple-15.2022' => 'Allows 15 return journeys within a calendar year.',
    'bilateral.permit.category.label.standard-multiple-15.2023' => 'Standard multiple journey permit for 2023',
    'bilateral.permit.category.hint.standard-multiple-15.2023' => 'Allows 15 return journeys within a calendar year.',
    'bilateral.permit.category.label.standard-multiple-15.2024' => 'Standard multiple journey permit for 2024',
    'bilateral.permit.category.hint.standard-multiple-15.2024' => 'Allows 15 return journeys within a calendar year.',
    'bilateral.permit.category.label.standard-multiple-15.2025' => 'Standard multiple journey permit for 2025',
    'bilateral.permit.category.hint.standard-multiple-15.2025' => 'Allows 15 return journeys within a calendar year.',
    'bilateral.permit.category.label.standard-multiple-15.2026' => 'Standard multiple journey permit for 2026',
    'bilateral.permit.category.hint.standard-multiple-15.2026' => 'Allows 15 return journeys within a calendar year.',
    'bilateral.permit.category.label.standard-multiple-15.2027' => 'Standard multiple journey permit for 2027',
    'bilateral.permit.category.hint.standard-multiple-15.2027' => 'Allows 15 return journeys within a calendar year.',
    'bilateral.permit.category.label.standard-multiple-15.2028' => 'Standard multiple journey permit for 2028',
    'bilateral.permit.category.hint.standard-multiple-15.2028' => 'Allows 15 return journeys within a calendar year.',
    'bilateral.permit.category.label.standard-multiple-15.2029' => 'Standard multiple journey permit for 2029',
    'bilateral.permit.category.hint.standard-multiple-15.2029' => 'Allows 15 return journeys within a calendar year.',
    'bilateral.permit.category.label.standard-multiple-15.2030' => 'Standard multiple journey permit for 2030',
    'bilateral.permit.category.hint.standard-multiple-15.2030' => 'Allows 15 return journeys within a calendar year.',
    'bilateral.permit.category.label.standard-single' => 'Standard single journey permit',
    'bilateral.permit.category.hint.standard-single' => 'Valid for one outward and one return journey within 3 months from the date of issue.',
    ...
    'permits.page.bilateral.countries.browser.title' => 'Select the countries you are transporting goods to or transiting through',
    'permits.page.bilateral.countries.question' => 'Select the countries you are transporting goods to or transiting through',
    'permits.page.bilateral.countries.essential.heading' => 'Essential information',
    'permits.page.bilateral.countries.essential.cabotage.heading' => 'What is cabotage?',
    'permits.page.bilateral.countries.essential.cabotage.desc' => 'Cabotage is the haulage and moving of goods for hire or reward between two points in the same country, carried out by a vehicle that is not registered in that country.',
    'permits.page.bilateral.countries.fee.table.heading' => 'Permits and fees',
    'permits.page.bilateral.countries.fee.table.bullet1' => 'Cabotage single or multiple journey permits that authorise cabotage jobs',
    'permits.page.bilateral.countries.fee.table.bullet2' => 'Standard multiple journey permits that allow unlimited return journeys',
    'permits.page.bilateral.countries.fee.table.bullet3' => 'Standard single journey permits that allow one outward and return journey',
    'permits.page.bilateral.countries.fee.table.footer' => 'This amount includes the application and issuing fees.',
    'permits.page.bilateral.countries-confirmation.question' => 'Confirm you want to change your countries selection',
    'permits.page.bilateral.countries-confirmation.browser.title' => 'Confirm you want to change your countries selection',
    'permits.page.bilateral.countries-confirmation.additional-guidance' => '<p class="govuk-body">By removing a country, all application information for that country will be removed.</p><p class="govuk-body">The following countries will be removed from this application:</p>',
    ...
    'permits.form.declaration.label' => 'I confirm that I understand the conditions and that the information I have provided is true and correct to the best of my knowledge.',
    ...
    'error.messages.permits.countries' => 'Select at least one country you need a permit for',
    ...
    'permits.form.declined_permit.label' => 'I confirm that I am declining these permits.',
    'permits.page.declined_permit.title' => 'Decline granted permits',
    ...
    'permits.irhp.permit.filter.status' => 'Status',
    ...
    'permits.irhp.valid.permits.table.type' => 'Type',
    ...
    'permits.irhp.valid.permits.table.issued-date' => 'Issued date',
    'permits.irhp.valid.permits.table.use-by-date' => 'Use by',
    'permits.irhp.valid.permits.filter-by-country' => 'Filter by country',
    ...
    'permits.irhp.under-consideration.title' => 'Application under consideration',
    'permits.irhp.under-consideration.application-details' => 'Application details',
    'permits.irhp.under-consideration.response-date.app_business_process_apsg' => 'We will contact you after the application period has closed and your application has been processed.',
    'permits.irhp.under-consideration.response-date.app_business_process_apgg' => 'We will contact you within 10 working days after the application submission date.',
    ...
    'permits.irhp.fee-breakdown.country' => 'Country',
    'permits.irhp.fee-breakdown.type' => 'Type',
    'permits.irhp.range.type.standard.single' => 'Standard single journey',
    'permits.irhp.range.type.standard.multiple' => 'Standard multiple journey',
    'permits.irhp.range.type.cabotage.single' => 'Cabotage single journey',
    'permits.irhp.range.type.cabotage.multiple' => 'Cabotage multiple journey',
    ...
    'permits.ecmt.sectors.food-products.description' => 'Beverages and tobacco, products of agriculture, hunting and forests, fish and other fishing products',
    'permits.ecmt.sectors.transport-and-machinery.description' => 'Equipment, machinery and equipment not elsewhere categorised, equipment and material utilised in the transport of goods',
    'permits.ecmt.sectors.metal.description' => 'Metal ores and other mining and quarrying products, peat, uranium and thorium, basic metals, fabricated metal products, except machinery and equipment',
    'permits.ecmt.sectors.chemicals.description' => 'Chemical products, man-made fibres, rubber and plastic products, nuclear fuel',
    'permits.ecmt.sectors.wood.description' => 'Products of wood and cork (except furniture), articles of straw and plaiting materials, pulp, paper and paper products, printed matter and recorded media',
    'permits.ecmt.sectors.furniture.description' => 'Other manufactured goods not elsewhere categorised, goods moved in course of household and office removals',
    'permits.ecmt.sectors.raw-materials.description' => 'Municipal wastes and other wastes',
    'permits.ecmt.sectors.refined-fuels.description' => 'Coke and refined petroleum products',
    ...
    'qanda.ecmt.permit-usage.question-short' => 'How will you use the permits',
    'qanda.ecmt.permit-usage.question' => 'How will you use your permits?',
    'qanda.ecmt.permit-usage.question-summary' => 'Permit usage',
    'qanda.ecmt.permit-usage.three-options.additional-guidance' => '<p class="govuk-body">You should only apply for this type of permit if:</p><ul class="govuk-list govuk-list--bullet"><li>from 1 January 2021 you are transiting through EU or EEA countries to reach non-EU or non-EEA countries that are ECMT member countries including Switzerland </li><li>during 2021, your journey includes more than two cross-trade trips between 2 EU or EEA countries, within 7 days of leaving the UK</li></ul>',
    'qanda.ecmt.permit-usage.four-options.additional-guidance' => 'You cannot use any ECMT permit for cabotage.',
    'qanda.ecmt.permit-usage.not-selected-message' => 'You must select an option',
    'qanda.ecmt.permit-usage.footer-annotation' => 'We may contact you by email or phone to verify your application.',
    'qanda.ecmt.permit-usage.three-options.option.transit-only.label' => 'Transit to non-EU countries only',
    'qanda.ecmt.permit-usage.three-options.option.transit-only.hint' => 'Transiting through EU and EEA countries to reach non-EU countries who are ECMT members. For example, collecting goods in the UK and driving through EU countries to deliver them in Russia.',
    'qanda.ecmt.permit-usage.three-options.option.cross-trade-only.label' => 'Cross-trade only',
    'qanda.ecmt.permit-usage.three-options.option.cross-trade-only.hint' => 'Collecting goods in one EU or EEA country and delivering to another EU or EEA country, which is not the UK. For example, collecting a load in France and dropping it off in Spain.',
    'qanda.ecmt.permit-usage.three-options.option.both.label' => 'For both cross-trade and transit',

    'qanda.ecmt.permit-usage.four-options.option.cross-trade-only.label' => 'Cross-trade only',
    'qanda.ecmt.permit-usage.four-options.option.cross-trade-only.hint' => 'Collecting goods in one EU or EEA country and delivering to another EU or EEA country, which is not the UK. For example, collecting a load in France and dropping it off in Spain.',
    'qanda.ecmt.permit-usage.four-options.option.non-eu-only.label' => 'Transit to non-EU countries only',
    'qanda.ecmt.permit-usage.four-options.option.non-eu-only.hint' => 'Transiting through EU and EEA countries to reach non-EU countries who are ECMT members. For example, collecting goods in the UK and driving through EU countries to deliver them in Russia.',
    ...
    'qanda.ecmt.permit-usage.four-options.option.ecmt-without.hint' => 'Any journey to transport goods (or drive an empty vehicle) between ECMT member countries without cross trade or transit journeys.',
    ...
    'qanda.ecmt.cabotage.question-short' => 'Cabotage',
    'qanda.ecmt.cabotage.question' => 'ECMT permits do not allow you to carry out cabotage',
    'qanda.ecmt.cabotage.question-summary' => 'Cabotage',
    'qanda.ecmt.cabotage.additional-guidance' => 'Cabotage is the haulage and moving of goods for hire or reward between two points in the same country, carried out by a vehicle that is not registered in that country.',
    'qanda.ecmt.cabotage.checkbox.label' => 'I confirm that I will not undertake cabotage journeys using an ECMT permit.',
    'qanda.ecmt.cabotage.checkbox.not-checked-message' => 'Tick to confirm your vehicle will not undertake cabotage journeys.',

    'qanda.common.certificates.question-short' => 'Certificates required',
    'qanda.common.certificates.question' => 'Mandatory certificates for vehicles and trailers you intend to use',
    'qanda.common.certificates.question-summary' => 'Certificates required',
    'qanda.common.certificates.additional-guidance' => '<p class="govuk-body">If your permit application is successful, you are required to have the appropriate <b>Certificate of Compliance</b> and <b>Certificate of Roadworthiness</b> for each vehicle and trailer you intend to use.</p><p class="govuk-body">You must carry your vehicle and trailer certificates at all times.</p><details class="govuk-details" data-module="govuk-details"><summary class="govuk-details__summary"><span class="govuk-details__summary-text">Where can I get the certificates?</span></summary><div class="govuk-details__text">You can apply for a Certificate of Roadworthiness using this service. It is issued by DVSA without charge.</div><div class="govuk-details__text">A Certificate of Compliance is supplied by the manufacturer of your vehicle or trailer.</div></details>',
    ...
    'qanda.ecmt.number-of-permits.question' => 'How many permits do you need?',
    'qanda.ecmt.number-of-permits.question-summary' => 'Number of permits',
    'qanda.ecmt.number-of-permits.inset.base' => 'There is a %s non-refundable application fee per permit. If your application is successful, you will need to pay an additional %s issuing fee for each permit granted.',
    'qanda.ecmt.number-of-permits.either.section-1.heading' => 'Select one euro emission standard',
    'qanda.ecmt.number-of-permits.either.section-1.blurb' => 'You cannot apply for permits for both emissions standards during the same application period.<br><br>There is a very limited number of permits for use with Euro 5 vehicles.',
    'qanda.ecmt.number-of-permits.either.section-2.heading' => 'Enter how many permits you need for the emission standard selected',
    'qanda.ecmt.number-of-permits.textbox.label.euro5' => 'Permits for Euro 5 minimum emission standard',
    'qanda.ecmt.number-of-permits.textbox.label.euro6' => 'Permits for Euro 6 minimum emission standard',
    'qanda.ecmt.number-of-permits.either.radio-label.euro5' => 'Euro 5 minimum emission standard',
    'qanda.ecmt.number-of-permits.either.radio-label.euro6' => 'Euro 6 minimum emission standard',
    'qanda.ecmt.number-of-permits.caption' => 'Number of permits',
    'qanda.ecmt.number-of-permits.hint' => '%s is the maximum number you can apply for.',
    'qanda.ecmt.number-of-permits.both.inset.supplement' => 'There is a very limited number of permits for use with Euro 5 vehicles.',
    'qanda.ecmt.number-of-permits.single.inset.supplement.euro5' => 'Only permits for use with Euro 5 vehicles are currently available. There is a very limited number of permits for use with Euro 5 vehicles.',
    'qanda.ecmt.number-of-permits.single.inset.supplement.euro6' => 'Only permits for use with Euro 6 vehicles are currently available.',
    'qanda.ecmt.number-of-permits.either.error.select-emissions-category' => 'Select one euro emission standard',
    'qanda.ecmt.number-of-permits.error.enter-permits-needed' => 'Enter how many permits you need',
    'qanda.ecmt.number-of-permits.error.total-min-exceeded' => 'Enter how many permits you need for at least one of the emission standards',
    'qanda.ecmt.number-of-permits.error.total-max-exceeded' => 'You have exceeded the maximum you can apply for',
    'qanda.ecmt.number-of-permits.error.permits-remaining-exceeded.euro5' => 'The maximum number of Euro 5 permits you can apply for is %permitsRemaining%. This is the total amount of this type left in the stock.',
    'qanda.ecmt.number-of-permits.error.permits-remaining-exceeded.euro6' => 'The maximum number of Euro 6 permits you can apply for is %permitsRemaining%. This is the total amount of this type left in the stock.',
    ...
    'qanda.ecmt-annual.restricted-countries.question.without.AT' => 'Will you be transporting goods to Greece, Hungary, Italy or Russia?',
    ...
    'qanda.ecmt-annual.restricted-countries.guidance' => '<p>There is a very small number of permits available for these countries.</p><p>We cannot guarantee if you receive a permit that it will allow you to travel to these countries.</p><p>Annual ECMT Euro 5 permits are not valid for journeys to or through Austria.</p>',
    'qanda.ecmt.restricted-countries.error.select-countries' => 'Select at least one country',

    'qanda.ecmt.annual-trips-abroad.question-short' => 'Annual trips abroad',
    'qanda.ecmt.annual-trips-abroad.question' => 'How many international trips did you make in the last 12 months using this licence?',
    'qanda.ecmt.annual-trips-abroad.question-summary' => 'International trips in last 12 months with this licence',
    'qanda.ecmt.annual-trips-abroad.guidance' => '<p>You will be required to provide evidence of the trips you made in the last 12 months.</p><p>If you have not done any international trips, you are unlikely to be awarded an ECMT permit. We intend to prioritise applications from hauliers who make the most international journeys.</p>',
    'qanda.ecmt.annual-trips-abroad.textbox.label' => 'Number of trips',
    'qanda.ecmt.annual-trips-abroad.textbox.hint' => 'One trip includes the outward and return journey, even if you pick up and drop off goods at different points or places along your journey.',
    'qanda.ecmt.annual-trips-abroad.error.enter-digits' => 'Enter the number of trips you carried out over the past 12 months',
    'qanda.ecmt.annual-trips-abroad.error.not-whole-number' => 'You must enter a valid whole number',
    'qanda.ecmt.annual-trips-abroad.error.max-exceeded' => 'You must enter a number which is below 999999',

    'qanda.ecmt.percentage-international-journeys.question-short' => 'Percentage of international journeys',
    'qanda.ecmt.percentage-international-journeys.question' => 'In the last 12 months, what percentage of international trips did you make using this licence?',
    'qanda.ecmt.percentage-international-journeys.question-summary' => 'Percentage of international trips with this licence',
    'qanda.ecmt.percentage-international-journeys.not-selected-message' => 'Select the percentage of international journeys over the past 12 months',

    'qanda.ecmt.sectors.question-short' => 'Goods you carry abroad',
    ...
    'qanda.ecmt-short-term.earliest-permit-date.additional-guidance' => '<p class="govuk-body">This information will help DVSA prioritise urgent requests. Consider jobs you already have scheduled or contracts you have in place that will require this permit.</p>',
    ...
    'qanda.certificate-of-roadworthiness.mot-expiry-date.additional-guidance' => '<p class="govuk-body">The Certificate of Roadworthiness expires on the same day as the MOT. You can check it on <a href="https://www.gov.uk/check-mot-history" target="_blank">GOV.UK.<span class="govuk-visually-hidden">(link opens in a new window)</span></a></p>',
    ...
    'qanda.ecmt-annual-2018.emissions.additional-guidance' => '<p class="govuk-body">If you intend to transport goods internationally the vehicles you use must meet and comply to all Euro 6 emission standards.</p><p class="govuk-body">This includes any vehicles you currently own or lease, or are intending to buy or least in the future.</p>',
    ...
    'qanda.bilaterals.cabotage-only.no-blurb' => 'You do not need permits for %s. We will remove it from your application when you click on \'Save and continue\'.<br><br>If this is the only country you are applying for, you can cancel this application on the next page.',
    'qanda.bilaterals.cabotage-only.additional-guidance.no' => '<p class="govuk-body">Between 1 January 2021 and 30 September 2021 you can continue transporting goods to Norway using a UK Licence for the Community.</p><p class="govuk-body">If you intend to carry out cabotage, you will need a Norway special permit for cabotage. This must be used together with the UK Licence for the Community.</p>',
    ...
    'qanda.bilaterals.cabotage-only.additional-guidance.hr' => '<p class="govuk-body">Between 1 January 2021 and 30 September 2021 you can continue transporting goods to Croatia using a UK Licence for the Community.</p><p class="govuk-body">If you intend to carry out cabotage, you will need a Croatia special permit for cabotage. This must be used together with the UK Licence for the Community.</p>',
    'qanda.bilaterals.standard-and-cabotage.additional-guidance.hr' => '<p class="govuk-body">Cabotage is the haulage and moving of goods for hire or reward between two points in the same country, carried out by a vehicle that is not registered in that country.</p><p class="govuk-body">From 1 October 2021, if you intend to carry out cabotage, you will need a Croatia special permit for cabotage. To be valid it must be used together with a Standard permit.</p>',
