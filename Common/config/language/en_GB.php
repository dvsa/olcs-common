...
return [
    ...
    'safety-inspector-external-hint-GB-goods' => 'You must have a contract if you use an external safety inspector. See <a href="https://www.gov.uk/government/uploads/system/uploads/attachment_data/file/341126/gv79-annex-d-maintenance-contract.pdf" target="_blank">sample contract</a>. You do not need to provide a copy of the contract as part of your application but must be able to provide it upon request.',
    'safety-inspector-external-hint-GB-psv' => 'You must have a contract if you use an external safety inspector. See <a href="https://www.gov.uk/government/uploads/system/uploads/attachment_data/file/341138/psv421-annex-c-maintenance-contract.pdf" target="_blank">sample contract</a>. You do not need to provide a copy of the contract as part of your application but must be able to provide it upon request.',
    'safety-inspector-external-hint-NI-goods' => 'You must have a contract if you use an external safety inspector. See <a href="https://www.infrastructure-ni.gov.uk/sites/default/files/publications/doe/goods-vehicle-operator%27s-licence-maintenance-contract.pdf" target="_blank">sample contract</a>. You do not need to provide a copy of the contract as part of your application but must be able to provide it upon request.',
    'save' => 'Save',
