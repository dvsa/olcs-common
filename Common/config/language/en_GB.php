...
return [
    ...
    'search.form.hint.publication' => 'Can include operator name, licence number, person, postcode, town or city',
    'search.form.hint.operator' => 'Can include operator name, licence number, person, postcode, town or city',
    'search.form.hint.bus' => 'Can include operator name, licence number, person, postcode, town or city',
    'search.form.hint.operating-centre' => 'Can include operator name, licence number, person, postcode, town or city',
    'search.form.hint.person' => 'Can include operator name, licence number, person, postcode, town or city',
    'search.form.hint.vehicle-external' => 'Can include operator name, licence number, person, postcode, town or city',
