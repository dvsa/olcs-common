...
return [
 ...
 to all known addresses? <br/> If yes, this will be automatically issued tomorrow.',
    ...
    //ecmt 19-20 changes
    'permits.page.no-of-permits.max.this.year' => '%d is the maximum number you can apply for this year.',
    'permits.page.no-of-permits.for.euro5.vehicles' => 'for Euro 5 minimum emissions standard',
    'permits.page.no-of-permits.for.euro6.vehicles' => 'for Euro 6 minimum emissions standard',
    'permits.page.no-of-permits.for.year' => 'Number of permits for %d',
    ...
    'qanda.ecmt-short-term.number-of-permits.error.no-fields-populated' => 'Enter the number of permits you require in one of the boxes',
    'qanda.ecmt-short-term.number-of-permits.error.two-or-more-fields-populated' => 'Enter the number of permits you require in one box only',
