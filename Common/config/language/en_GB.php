...
return [
    ...
    'dashboard-correspondence-empty-message' => 'You don\'t have any correspondence',
    ...
    'page.title.my-account.edit' => 'My account',
    ...
    'page.title.correspondence.index' => 'Correspondence',
    ...
    'selfserve-dashboard-topnav-my-account' => 'My account',
    ...
    'variation-message' => 'To change this page you\'ll need to <a href="%s" class="js-modal-ajax">start a variation application</a>.',
