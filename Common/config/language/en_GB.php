...
return [
 ...
 to all known addresses? <br/> If yes, this will be automatically issued tomorrow.',
    ...
    'qanda.ecmt.permit-usage.three-options.option.transit-only.hint' => 'Transiting through EU and EEA countries to reach non-EU countries who are ECMT members',
    'qanda.ecmt.permit-usage.three-options.option.cross-trade-only.label' => 'Cross-trade only',
    'qanda.ecmt.permit-usage.three-options.option.cross-trade-only.hint' => 'Collecting goods in one EU or EEA country and delivering to another EU or EEA country, which is not the UK',
