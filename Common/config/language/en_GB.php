...
return [
    ...
    'continuations.finances.averageBalance.notBetween' => 'Your average balance must be between %min% and %max%',
    ...
    'continuations.finances.overdraftFacility.amount.notBetween' => 'Your overdraft limit must be between %min% and %max%',
    ...
    'continuations.finances.factoring.amount.notGreaterThan' => 'You cannot enter a negative amount',
    'continuations.finances.factoring.amount.notLessThan' => 'You cannot enter an amount greater than %max%',
