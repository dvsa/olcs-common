...
return array(
    ...
    'FHAdditionalInfo.validation.too_short' => 'You selected \'yes\' in one of the provided questions, so the input has
    ...
    'application_taxi-phv_licence-sub-action.data.licenceNumber' => 'Taxi/PHV licence number',
