...
return [
 ...
 to all known addresses? <br/> If yes, this will be automatically issued tomorrow.',
    ...
    'qanda.ecmt.number-of-permits.additional-guidance' => '<p>There is a %s non-refundable application fee per permit required.</p><p>If successful, you\'ll pay an additional %s issuing fee per permit granted.</p>',
    ...
    'qanda.certificate-of-roadworthiness.mot-expiry-date.additional-guidance' => 'The Certificate of Roadworthiness expires on the same day as the MOT. You can check it on <a href="https://www.gov.uk/check-mot-history" target="_blank">GOV.UK.<span class="govuk-visually-hidden">(link opens in a new window)</span></a>',
