...
return array(
    ...
    . "Please note: you can multiple Taxi/PHV licences to an application provided they are located in the same traffic area",
    ...
    'application_taxi-phv_licence.trafficArea.hint.new' => 'Your traffic area is determined based on the first Taxi/PHV licence address.<br />'
    ...
    'application_taxi-phv_licence.trafficArea.labelasahint.exists' => '<p class="hint">Your traffic
        area has been determined from your council address.<br/><a href="#" target="_blank">More about traffic areas</a></p>',
