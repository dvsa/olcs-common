...
return [
    ...
    'lva-oc-adplaced-y-selfserve' => 'Upload',
    ...
    'supply-supporting-evidence-text-2-ni' => 'Post these documents to the <a href="{{OPENING_TIMES_LINK_NI}}" target="_blank">Central Licensing Office</a>, along with your application reference number.',
    'surname' => 'Surname',
    't-auth' => 'T-auth',
