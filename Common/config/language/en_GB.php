...
return [
    ...
    'vehicle.error.platedWeight.notDigits' => 'Value must be rounded digital in kilograms',
    'vehicle.error.vrm.invalid' => 'Invalid registration number (only characters and digits allowed)',
    'vehicle.error.vrm.lengthInvalid' => 'Value must be between %min% and %max% characters long.',
    'vehicle.error.modelName.invalid' => 'Value must be between %min% and %max% characters long.',
