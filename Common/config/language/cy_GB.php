...
return [
    ...
    'selfserve-app-subSection-previous-history-criminal-conviction-hasConv' => '{WELSH} <div class="article"><p>Does anyone you’ve named in your application have a conviction that the Traffic Commissioner must be told about?</p><p>This question also applies to:</p><ul><li>Directors, Partners and Transport Managers</li><li>companies that are (or have been) directed by anybody you’ve named</li><li>your parent company, if you’re a limited company</li><li>your employees and agents</li></ul></div>',
