...
return [
    ...
    'bus-registrations-index-subtitle' => '{WELSH} In order to register, update or cancel a bus service online you need to upload an Electronic Bus Service Registration pack (EBSR) in .ZIP format.',
    ...
    'ebsr-upload-subtitle' => '{WELSH} You can apply to register, change or cancel bus services online through the electronic bus service registration (EBSR) service.',
    'ebsr-upload-title' => '{WELSH} Register, change or cancel bus services',
    'ebsr-upload-before' => '{WELSH} Before you upload',
    'ebsr-support' => '{WELSH} If you haven\'t done this before you\'ll need to email <a href="mailto:{{EBSR_SUPPORT_EMAIL}}">{{EBSR_SUPPORT_EMAIL}}</a> or call {{EBSR_SUPPORT_NUMBER}}.',
